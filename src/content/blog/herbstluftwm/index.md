---
title: Herbstluftwm Guide
author: Daniel Xu
pubDatetime: 2023-06-15T10:21:26-07:00
featured: true
draft: false
tags:
  - Wms
  - Ricing
  - Linux
description: "It might have a mouthful of a name, but it is my favorite window manager."
---
...
![BSP-like window spawning](./images/bsp.png)

### Scratchpad

The one thing that I require in a window manager is a scratchpad feature. Hlwm does not have a _built in_ scratchpad, but I wrote a handy dandy little script that spawns a terminal scratchpad that can be hidden and opened on any tag.
...
![Hlwm scratchpad](./images/spad.png)
...
![Hlwm window states](./images/states.png)
